...
const NiveauManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentNiveau) {
        await niveauService.updateNiveau(currentNiveau.id, formData);
      } else {
        await niveauService.createNiveau(formData);
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Gestion des Niveaux</h2>
          <p className="text-sm text-gray-500">Définissez les différents niveaux d'études</p>
        </div>
        <motion.button
          ...
          >
            ...
            >
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                {currentNiveau ? 'Modifier le niveau' : 'Nouveau niveau'}
              </h3>
