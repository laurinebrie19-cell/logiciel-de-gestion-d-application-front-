...
const FiliereManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentFiliere) {
        await filiereService.updateFiliere(currentFiliere.id, formData);
      } else {
        await filiereService.createFiliere(formData);
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Gestion des Filières</h2>
          <p className="text-sm text-gray-500">Gérez les différentes filières de votre établissement</p>
        </div>
        <motion.button
          ...
          >
            ...
            >
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                {currentFiliere ? 'Modifier la filière' : 'Nouvelle filière'}
              </h3>
